...
* if GET DATA failed, open datarep\dat_T2_replicate.xlsx, paste its content to a new xlse file and open the new xlsx file here.
GET DATA /TYPE=XLSX
  /FILE='\path_to_your_directory\datarep\dat_T2_replicate.xlsx'
  /SHEET=name 'Sheet1'
  /CELLRANGE=full
  /READNAMES=on
